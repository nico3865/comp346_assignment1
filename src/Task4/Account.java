...
/**
 * Class Account Implements one customized customer account for many of our own
 * threads.
 * 
 * @author Malek Barhoush, mbarhoush@hotmail.com;
 * 
 * 
 *         $Revision: 1.0 $ $Last Revision Date: 2012/09/03
 */
...
public class Account {
	 ...
	 * 
	 * @param acc
	 *            A unique integer that represents account number
	 * @param name
	 *            A string indicating human-readable customer's name
	 * @param balance
	 ...
	 * 
	 * @param acc
	 *            A unique int for acoount number
	 */
	 ...
	 * 
	 * @param name
	 *            A string that represents a customer name
	 */
	 ...
	 * 
	 * @param balance
	 *            A double that represents an account balance
	 */
	...
	public String toString() {
		return "Account: " + acc + " \tName: " + name + " \tBalance:\t"
				+ balance;
	}
	 ...
	 * 
	 * @param amount
	 *            A double that represents a deposit amount
	 */
	public void debosit(double amount) {
		
		// System.out.print("in debosit");
	 ...
	 * 
	 * @param amount
	 *            A double that represents a withdrawal amount
	 */
